...
<div class="box-header with-border">
  ...
  <div class="pull-right">
    <a href="?a=tambah_siswa" class=" btn btn-info btn-sm" style="background: #4682b4">Tambah Siswa</a> 
  </div>
...
?>
  ...
  <!-- <td><?php echo $kelas; ?></td> -->
    ...
    <a href="?a=detail_siswa&id=<?php echo $data['id_siswa'] ?>&t=0&status=0" class="btn btn-success btn-xs">Detail Siswa</a> 
	</td>
		</tr>
