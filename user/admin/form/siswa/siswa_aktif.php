...
<div class="box-header with-border">
  ...
  <div class="pull-right">
  	<a href="form/siswa/print_siswa_aktif.php" class=" btn btn-info btn-sm" style="background: #4682b4">
          <i class="fa fa-add"></i> Print Data Siswa Aktif</a>
  </div>
...
$tgll = $pt[2].'-'.$pt[1].'-'.$pt[0];?>
	...
	<td class="text-center"><a href="?a=detail_siswa&id=<?php echo $data['id_siswa'] ?>&t=0&status=1" class="btn btn-success btn-xs">Detail Siswa</a> 
	</td>
		</tr>
