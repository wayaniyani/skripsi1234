...
<div class="pull-right">
      <a href="<?php echo $targetback ?>" class="btn btn-info btn-sm" style="background: #4682b4" >Kembali</a>
    </div>
...
<div class="box-header with-border">
  ...
  <div class="pull-right">
    <a href="#" class=" btn btn-info btn-xs" style="background: #4682b4" data-toggle="modal" data-target="#inputnilai">Input Nilai</a>
  </div>
  ...
  <table class="table table-striped table-bordered">
    ...
    <tr>
      ...
      <td colspan="4">
        ...
        <br>
        <a href="#" class=" btn btn-info btn-xs" style="background: #4682b4" data-toggle="modal" data-target="#keputusan">Keputusan Kelulusan</a>
      </td>
      <?php }
        } ?>
    </tr>
    <tr>
      <td colspan="4"><u>Catatan Guru</u> <br>
        ...
        <?php if ($semester=='1') { ?> <br>
          <a href="#" class=" btn btn-success btn-xs"  data-toggle="modal" data-target="#keputusan">Input Catatan Guru</a>
        <?php } ?>
      </td>
    </tr>
   ...
   <a href="form/history_kelas_siswa/print_rapor_siswa.php?id=<?php echo $id ?>&id_kelas=<?php echo $id_kelas ?>&id_ta=<?php echo $id_ta_aktif ?>&status_ks=<?php echo $status_ks ?>&semester=<?php echo $semester ?>&tingkat=<?php echo $tingkat ?>&status_ta=<?php echo $status_ta ?>" class=" btn btn-info btn-sm" style="background: #4682b4">
          <i class="fa fa-add"target="_blank">Print Rapor Semester <?php echo $nama_semester[1] ?></i></a>
</div>
